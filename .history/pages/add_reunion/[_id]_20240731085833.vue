...
<div class="addUser">
      ...
      <ListBox v-model="personasSeleccionadas" :options="formattedPersonas" optionLabel="optionLabel" multiple filter style="width: 100%; height: 500px;">
        ...
        <div class="flex items-center">
            <img :alt="slotProps.name" src="https://primefaces.org/cdn/primevue/images/flag/flag_placeholder.png" :class="`flag flag-${slotProps.option.code.toLowerCase()} mr-2`" style="width: 18px" />
