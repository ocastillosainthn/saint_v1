  ...
  <div>
    ...
    <k-popup :opened="noVisita" @backdropclick="closeNoVisita" class="popMedia">
      ...
      <div style="padding: 20px; text-align: center;">
        <p style="margin-bottom: 20px;">No se encontró ninguna visita registrada con ese código qr.</p>
        <kButton style="height: 40px;" @click="scanAgain">Escanear de nuevo</kButton>
      </div>
    </k-popup>
  </div>
</template>
