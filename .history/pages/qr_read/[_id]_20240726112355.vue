  ...
  <div>
    ...
    <k-popup :opened="popupOpened" @backdropclick="() => (popupOpened = false)" class="popMedia">
     ...
     <div>
        ...
        <div>
          <Icon name="streamline:interface-time-reset-time-clock-reset-stopwatch-circle-measure-loading" style="font-size: 13px; color: gray; margin-top: 0px; margin-bottom: 3px;" />
         Entrada {{ participanteSelected.entrada }} 
        </div>

        <div>
          <Icon name="streamline:interface-time-rewind-back-return-clock-timer-countdown" style="font-size: 13px; color: gray; margin-top: 0px; margin-bottom: 3px;" />
