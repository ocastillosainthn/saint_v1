      ...
      <div style="padding: 20px;">
        ...
        <div>
          ...
          <div class="itemPersona"> 
            <div>Nombre </div>
            <div style="font-weight: 700;"> {{ participanteSelected.persona?.nombre }} </div>
          </div>
          ...
          <div class="itemPersona"> 
            <div>Teléfono </div>
            <div> {{ participanteSelectedinfo <Suspense> is an experimental feature and its API will likely change.
browser.mjs:44 error [nuxt] error caught during app initialization TypeError: Cannot read properties of null (reading 'persona')
    at [_id].vue:108:119
    at renderFnWithContext (runtime-core.esm-bundler.js:827:13)
    at renderSlot (runtime-core.esm-bundler.js:2973:53)
    at Popup.vue:4:5
    at renderFnWithContext (runtime-core.esm-bundler.js:827:13)
    at normalizeChildren (runtime-core.esm-bundler.js:7376:34)
    at createBaseVNode (runtime-core.esm-bundler.js:7184:5)
    at _createVNode (runtime-core.esm-bundler.js:7261:10)
    at createVNodeWithArgsTransform (runtime-core.esm-bundler.js:7139:10)
    at createBlock (runtime-core.esm-bundler.js:7113:5)
log @ browser.mjs:44
_log @ core.mjs:381
...
processComponent @ runtime-core.esm-bundler.js:5883
patch @ runtime-core.esm-bundler.js:5351
hydrate2 @ runtime-core.esm-bundler.js:4646
mount @ runtime-core.esm-bundler.js:3936
app.mount @ runtime-dom.esm-bundler.js:1554
initApp @ entry.js:55
await in initApp (async)
(anonymous) @ entry.js:66Understand this error
devtools.client.mjs:49 .persona?.telefono }} </div>
          </div>
     ...
     <div v-if="participanteSelected.persona.empresa">
          <div class="itemPersona"> 
            <div>Empresa </div>
...
<div class="listTime"> 
        <div >
          <Icon name="material-symbols:arrow-forward" style="font-size: 13px; color: gray; margin-top: 0px; margin-right: 6px;" />
         Entrada {{ fechaEntradaAmigable}} 
        </div>

        <div>
          <Icon name="material-symbols:arrow-back" style="font-size: 13px; color: gray; margin-top: 0px; margin-right: 6px;" />
...
const fechaEntradaAmigable = computed(() => {
  return participanteSelected.value ? formatDate(participanteSelected.value.entrada) : 'Sin entrada registrada';
});

const fechaSalidaAmigable = computed(() => {
  return participanteSelected.value ? formatDate(participanteSelected.value.salida) : 'Sin salida registrada';
});
