...
<div class="listTime"> 
        <div  >
          <div style="width:120px; margin-bottom: 6px;"> Entrada </div>
          <Icon name="material-symbols:arrow-forward" class="iconIO" />
          {{ fechaEntradaAmigable}} 
        </div>

        <div>
          <div style="width:120px; margin-bottom: 6px;"> Salida </div>
          <Icon name="material-symbols:arrow-back" class="iconIO salida" />
          {{ fechaSalidaAmigable }} 
        </div>
